...
Теперь пакет использует только примитивы, доступные в обеих сборках; это
зафиксировано тестом (`совместимость с react-native-libsodium`) и проверкой
наличия функций при старте приложения.
