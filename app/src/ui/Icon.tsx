...
function renderPaths(name: IconName, c: CommonProps, color: string): React.ReactElement {
  switch (name) {
    ...
    case "settings":
      // Шестерня, а не звёздочка из тонких лучей: раньше эта иконка отличалась
      // от «sun» (тоже круг с расходящимися линиями, см. ниже) только числом
      // и длиной лучей — на 22px в шапке это неразличимо, и кнопка настроек
      // выглядела как переключатель темы. Зубцы посчитаны так же, как знак
      // приложения (scripts/make-icons.py) — тригонометрией, а не на глаз.
      return (
        <>
          <Path
            {...c}
            d="M21.28 10.53 L21.28 13.47 L18.91 13.1 L17.66 16.11 L19.6 17.53 L17.53 19.6 L16.11 17.66 L13.1 18.91 L13.47 21.28 L10.53 21.28 L10.9 18.91 L7.89 17.66 L6.47 19.6 L4.4 17.53 L6.34 16.11 L5.09 13.1 L2.72 13.47 L2.72 10.53 L5.09 10.9 L6.34 7.89 L4.4 6.47 L6.47 4.4 L7.89 6.34 L10.9 5.09 L10.53 2.72 L13.47 2.72 L13.1 5.09 L16.11 6.34 L17.53 4.4 L19.6 6.47 L17.66 7.89 L18.91 10.9 Z"
          />
          <Circle {...c} cx="12" cy="12" r="2.9" />
        </>
      );
    case "plus":
    ...
    case "search":
      return (
        <>
          <Circle {...c} cx="10.6" cy="10.6" r="6.6" />
          <Path {...c} d="M15.5 15.5L20.5 20.5" />
        </>
      );
  }
}
