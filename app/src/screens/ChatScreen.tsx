  ...
  return (
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background, paddingBottom: keyboard.avoidOffset }]}>
      ...
      <FlatList
        ...
        // невелик.
        //
        // initialNumToRender сознательно небольшой: экран открывается ПОД
        // анимацию перехода (см. Navigator.tsx), а создание нативных вьюх для
        // первой партии сложных пузырей (у каждого свои SVG-галочки) идёт на
        // том же UI-потоке, что и сам трансформ перехода — «нативный драйвер»
        // экономит JS-поток, но не главный. Меньше вьюх в первой партии —
        // меньше конкуренции за кадр ровно в те 280 мс, когда она заметнее
        // всего. Остальное доезжает вторыми батчами почти сразу после.
