    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 32 }]}>
        ...
        <Card>
          ...
          <View style={[styles.block, { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: theme.colors.divider }]}>
            <Text style={[styles.hint, { color: theme.colors.textMuted, marginTop: 0 }]}>
              {backgroundAvailable
                ? "Уведомления приходят и после сворачивания. Android требует беззвучное уведомление «Cry на связи» внизу шторки — убрать его нельзя."
                : "Этой сборке нужен новый APK для работы в фоне — пока уведомления приходят только при открытом Cry."}
            </Text>
          </View>
          <Pressable
            style={({ pressed }) => [
          ...
          <View style={[styles.block, { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: theme.colors.divider }]}>
            <Text style={[styles.hint, { color: theme.colors.textMuted, marginTop: 0 }]}>
              Не приходят, только если Cry открыт? Включите «Работать в фоне» выше, затем: Приложения → Cry → Батарея →
              «Без ограничений» (на Samsung ещё убрать Cry из «Спящих приложений»).
            </Text>
            {permissionDenied && (
        ...
        <Card>
          ...
          <View style={[styles.block, { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: theme.colors.divider }]}>
            <Text style={[styles.hint, { color: theme.colors.textMuted, marginTop: 0 }]}>
              Закрывает переписку от того, кто взял телефон в руки — связь и уведомления работают как обычно. Код не
              восстанавливается: забыли — значит переустановка и потеря ключей со всей перепиской.
            </Text>
          </View>
        </Card>
        ...
        <Card>
          {email === null ? (
            <>
              ...
              >
                ...
                <Text style={[styles.failure, { color: theme.colors.danger, marginTop: 0 }]}>
                  Почта не привязана — войти с другого телефона нечем, потеря телефона = потеря доступа.
                </Text>
                <Text style={[styles.hint, { color: theme.colors.textMuted }]}>
                  Привязка ничего не меняет — аккаунт, переписка и контакты остаются те же, добавляется только способ
                  войти.
                </Text>
              </View>
            </>
            ...
            <View style={styles.block}>
              ...
              <Text style={[styles.hint, { color: theme.colors.textMuted }]}>
                Вход с нового телефона вернёт аккаунт и контакты. Переписку — только резервная копия ниже.
              </Text>
            </View>
          )}
        </Card>
        ...
        <Card>
          ...
          <View style={[styles.block, { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: theme.colors.divider }]}>
            ...
            <Text style={[styles.hint, { color: theme.colors.textMuted }]}>
              Шифруется вашей фразой прямо на телефоне — сервер получает только шифротекст. Фраза не восстанавливается:
              забыли — копия потеряна. Без фото и голосовых (останутся подписи) и без сообщений, пришедших после
              копии — их сервер уже удалил.
            </Text>
          </View>
        </Card>
        ...
        <Card>
          <View style={styles.block}>
            ...
            />
            <Text style={[styles.hint, { color: theme.colors.textMuted }]}>
              «Ждут отправки» больше нуля при «connected» — сервер не подтверждает приём, вероятно старая версия.
            </Text>
            {steps !== null && (
