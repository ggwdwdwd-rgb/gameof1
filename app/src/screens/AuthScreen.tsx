    ...
    >
      ...
      >
        ...
        <Text style={[styles.footer, { color: theme.colors.textMuted }]}>
          ...
          {registering
            ? " Заведите потом резервную копию в настройках: без неё переписка не переедет на новый телефон."
            : " После входа с нового телефона чаты будут пустыми: прежние сообщения расшифровываются ключами прежнего устройства. Вернуть их можно только из резервной копии — она восстанавливается в настройках кодовой фразой."}
        </Text>
      </ScrollView>
    </KeyboardAvoidingView>
  );
